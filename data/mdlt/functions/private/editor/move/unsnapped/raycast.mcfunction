...
execute unless block ~ ~ ~ #mdlt:raycastthrough align y positioned ~ ~1 ~ as @e[type=armor_stand,tag=mdlt_model] if score @s mdlt.model.id = @a[tag=temp_player,limit=1] mdlt.model.id run function mdlt:private/editor/move/common/move
